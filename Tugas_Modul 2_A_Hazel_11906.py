...
model_path = 'D:\perkuliahan\semester 5\PMDPM\Pertemuan 4\TUGAS_A_11906'
...
if st.button("Prediksi"):
    rf_model_predicition = rf_model.predict(input_data)
    outcome= {0:'Tidak Berpotensi skait jantung', 1:'Berpotensi sakit jantung'}
    st.write(f"Orang tersebut diprediksi **{outcome[rf_model_predicition[0]]}**")